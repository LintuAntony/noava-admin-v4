    ...
    <div className="wrapper">
		...
		<div className="sidebar-wrapper" data-simplebar="true">
			<div className="sidebar-header">
				<div>
					<img src="../assets/images/favicon.png" className="logo-icon" alt="logo icon"/>
				</div>
				<div>
					<h4 className="logo-text text-black"><b>Noava</b></h4>
				</div>
			...
			<li>
				...
				<li>
					...
					<ul>
					<li> <a href="sub-category"><i className='bx bx-radio-circle'></i>SubCategory</a>
						</li>
						<li> <a href="tables"><i className='bx bx-radio-circle'></i>MainCategory</a>
						</li>
						</ul>
						</li>
				...
				{/* <li>
					...
					<ul>
						<li> <a href="default"><i className='bx bx-radio-circle'></i>Default</a>
						</li>
